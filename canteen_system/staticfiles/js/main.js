...
function applyFilters() {
    const filters = {
        ...
        priceMax: document.getElementById('price-max')?.value || '50',
        crowd: document.querySelector('input[name="crowd"]:checked')?.value || 'any'
    };
...
function resetFilters() {
    ...
    if (priceRangeMax) priceRangeMax.value = '50';
    
    const crowdAny = document.getElementById('crowd-any');
    if (crowdAny) crowdAny.checked = true;
